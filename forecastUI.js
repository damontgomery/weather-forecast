...
const getChartTemperatureBounds = (forecastPoints) => {
    const temperatures = [
...
export function drawInterface({ screenElement, forecastPoints, previousScreenHandler = () => { }, nextScreenHandler = () => { }, zoomOutScreenHandler = () => { }, zoomInScreenHandler = () => { }, }) {
    ...
    const getDateLabels = (forecastPoints) => {
    ...
    const getTimeGridLines = (forecastPoints) => {
    ...
    const getTemperatureGridLines = (forecastPoints) => {
    ...
    const getTemperatureLine = ({ propertyName, className }) => getPolyline({
    ...
    const getPrecipitationGridLines = (forecastPoints) => {
    ...
    const getPrecipitationLines = (forecastPoints) => {
        ...
        const getPrecipitationLine = ({ propertyName, className }) => getPolyline({
            points: forecastPoints.map((forecastPoint, i) => {
